...
import com.coma.go.Dagger.Misc.AuthenticatorModule;
...
public class LoginActivity extends AppCompatActivity  {
    ...
    private void subscribe(String session, String email, String password) {
        if(session.equals("")){

            Logger.e("errorAccepted", " :" + session);
        }else{
            saveSession(session, getApplication());
            SignViewModel.saveCredi(email, password, LoginActivity.this);
